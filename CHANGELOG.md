...
- Interactive verification in ITGmania of the local-file tagline AND the new marquee effect (title screen render, file edit + revisit, a message long enough to trigger scrolling) not yet performed.
