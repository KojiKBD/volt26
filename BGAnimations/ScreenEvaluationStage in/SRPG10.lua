...
local af = Def.ActorFrame{
	...
	Def.Sound{
		Name="Victory",
		File=THEME:GetPathG("", "_VisualStyles/SRPG10/Eval/Victory.ogg"),
	},
	Def.Sound{
		Name="Failed",
		File=THEME:GetPathG("", "_VisualStyles/SRPG10/Eval/Failed_theme.ogg"),
	},
}

if failed then
	local sPath    = "_VisualStyles/SRPG10/Eval/defeat_animation_res/"
    local startNum = 0
    local endNum   = 38
	local tytPath    = "_VisualStyles/SRPG10/Eval/tyt_res/"
    local fFPS     = 24
    local fDelay   = 1 / fFPS


	af[#af+1] = Def.Sprite{
		Texture=THEME:GetPathG("", "_VisualStyles/SRPG10/Eval/defeat.png"),
		InitCommand=function(self)
			self:zoom(0.5)
			--self:x(-200):y(100) 
		end,
...
local maxLoops = 2
	...
	-- af[#af+1] = Def.Sprite{
	-- 	Texture=THEME:GetPathG("", "_VisualStyles/SRPG10/Eval/srpg.png"),
	-- 	InitCommand=function(self)
	-- 		self:zoomto(SCREEN_WIDTH, SCREEN_HEIGHT)
	-- 	end,
	-- 	OnCommand=function(self)
    ...
    local sPath    = "_VisualStyles/SRPG10/Eval/victory_animation_res/"
    local startNum = 7
    local endNum   = 60
    local fFPS     = 24
    local fDelay   = 1 / fFPS
